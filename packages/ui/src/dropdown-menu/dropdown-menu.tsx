...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(subTrigger({ inset }), className)}
    {...props}
  >
    {children}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(menuItem({ inset }), className)}
    {...props}
  />
))
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(menuCheckboxItem(), className)}
    checked={checked}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    className={cn(menuRadioItem(), className)}
    {...props}
  >
    <span className={menuRadioItemSpan()}>
      <DropdownMenuPrimitive.ItemIndicator>
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(menuLabel({ inset }), className)}
    {...props}
  />
))
...
>(({ className, spacing, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn(separator({ spacing }), className)}
    {...props}
  />
))
