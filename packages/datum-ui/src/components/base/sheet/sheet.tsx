  ...
  return (
    <SheetPrimitive.Portal data-slot="sheet-portal">
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-[var(--ease-drawer)] data-[state=closed]:duration-[var(--duration-drawer-out)] data-[state=open]:duration-[var(--duration-drawer-in)]',
          side === 'right'
