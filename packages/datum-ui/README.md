...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `@datum-cloud/datum-ui`           | Root barrel — every component except the subpath-only picker family (`./picker`, `./date-picker`); requires all peer deps |
...
| ----------------------------------- | -------------------------------------------------------------------------------- | --------------------------------------------- |
| `@datum-cloud/datum-ui/picker`      | `Picker.*`, `DateTimeRangePicker`, `DatePicker`, `DateRangePicker`, `TimePicker` | `date-fns`, `date-fns-tz`                     |
| `@datum-cloud/datum-ui/date-picker` | `CalendarDatePicker`, `TimeRangePicker` (compat alias)                           | `react-day-picker`, `date-fns`, `date-fns-tz` |
...
Each component's tree-shakeable subpath is the kebab-case of its directory, e.g. `@datum-cloud/datum-ui/multi-select`, `@datum-cloud/datum-ui/app-navigation`, `@datum-cloud/datum-ui/grouped-table`. The picker family lives under `@datum-cloud/datum-ui/picker` (see [Grouped Exports](#grouped-exports)).
...
| `Form`, `FormField`, `FormInput`, `FormTextarea`, `FormSelect`, `FormCombobox` (`Form.Combobox`), `FormCheckbox`, `FormSwitch`, `FormRadioGroup`, `FormFieldArray` | See [Form Adapters](#form-adapters) below | Form system with pluggable adapter support. `Form.Combobox` is the searchable single-select field (delegates to `Autocomplete`) |
...
| `AppNavigation` (`@datum-cloud/datum-ui/app-navigation`)                                                                                                           | —                                         | Application navigation menu                                                                                                     |
| `Logo` (`@datum-cloud/datum-ui/logo`, themed via `/logo/themed`)                                                                                                   | —                                         | Datum logo (plain and theme-aware)                                                                                              |
| `MultiSelect` (`@datum-cloud/datum-ui/multi-select`)                                                                                                               | —                                         | Multi-value select with search                                                                                                  |
| `GroupedTable` (`@datum-cloud/datum-ui/grouped-table`)                                                                                                             | `@tanstack/react-table`                   | Table with collapsible row groups                                                                                               |
| `RichTextEditor` (`@datum-cloud/datum-ui/rich-text-editor`)                                                                                                        | `@tiptap/react`, `@tiptap/starter-kit`    | TipTap-based rich text editor                                                                                                   |
| `Picker`, `DateTimeRangePicker`, `DateRangePicker`, `DatePicker`, `DateRangeTimePicker` (`@datum-cloud/datum-ui/picker`)                                           | `date-fns`, `date-fns-tz`                 | Composable date/time picker family (subpath-only)                                                                               |
