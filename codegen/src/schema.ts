...
export interface CreateUserSettingInput {
  ...
  defaultOrg: InputMaybe<Scalars['String']['input']>;
...
export interface UserSettingWhereInput {
  ...
  defaultOrg: InputMaybe<Scalars['String']['input']>;
  defaultOrgContains: InputMaybe<Scalars['String']['input']>;
  defaultOrgContainsFold: InputMaybe<Scalars['String']['input']>;
  defaultOrgEqualFold: InputMaybe<Scalars['String']['input']>;
  defaultOrgGT: InputMaybe<Scalars['String']['input']>;
  defaultOrgGTE: InputMaybe<Scalars['String']['input']>;
  defaultOrgHasPrefix: InputMaybe<Scalars['String']['input']>;
  defaultOrgHasSuffix: InputMaybe<Scalars['String']['input']>;
  defaultOrgIn: InputMaybe<Array<Scalars['String']['input']>>;
  defaultOrgIsNil: InputMaybe<Scalars['Boolean']['input']>;
  defaultOrgLT: InputMaybe<Scalars['String']['input']>;
  defaultOrgLTE: InputMaybe<Scalars['String']['input']>;
  defaultOrgNEQ: InputMaybe<Scalars['String']['input']>;
  defaultOrgNotIn: InputMaybe<Array<Scalars['String']['input']>>;
  defaultOrgNotNil: InputMaybe<Scalars['Boolean']['input']>;
  /** deleted_at field predicates */
  deletedAt: InputMaybe<Scalars['Time']['input']>;
  deletedAtGT: InputMaybe<Scalars['Time']['input']>;
  deletedAtGTE: InputMaybe<Scalars['Time']['input']>;
...
export type ResolversInterfaceTypes<RefType extends Record<string, unknown>> = {
  Node: ( Entitlement ) | ( Group ) | ( GroupMembership ) | ( GroupSetting ) | ( Integration ) | ( Invite ) | ( OauthProvider ) | ( OhAuthTooToken ) | ( OrgMembership ) | ( Organization ) | ( OrganizationSetting ) | ( PersonalAccessToken ) | ( User ) | ( UserSetting );
};
...
export type NodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = {
  __resolveType: TypeResolveFn<'Entitlement' | 'Group' | 'GroupMembership' | 'GroupSetting' | 'Integration' | 'Invite' | 'OauthProvider' | 'OhAuthTooToken' | 'OrgMembership' | 'Organization' | 'OrganizationSetting' | 'PersonalAccessToken' | 'User' | 'UserSetting', ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  invites: Resolver<ResolversTypes['InviteConnection'], ParentType, ContextType, Partial<QueryInvitesArgs>>;
...
export type UserSettingResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSetting'] = ResolversParentTypes['UserSetting']> = {
  createdAt: Resolver<ResolversTypes['Time'], ParentType, ContextType>;
  createdBy: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  defaultOrg: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  deletedAt: Resolver<Maybe<ResolversTypes['Time']>, ParentType, ContextType>;
  deletedBy: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
