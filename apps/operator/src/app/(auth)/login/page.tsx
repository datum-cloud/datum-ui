    ...
    <main className="flex flex-col min-h-screen w-full items-center space-between dark:bg-dk-surface-0 bg-surface-0">
      <div className="flex flex-col justify-center mx-auto my-auto w-full p-6 sm:w-1/3 h-full relative ease-in-out">
        ...
        <div className="flex flex-col mt-8 justify-start">
          ...
          <button onClick={() => {
            github()
          }} type="button" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex justify-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-1 mb-2 ml-1">
          ...
          <button onClick={() => {
            google()
          }} type="button" className="!text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex justify-center dark:focus:ring-[#4285F4]/55 me-1 mb-2 ml-1">
