...
function DefaultStory(args: ComponentProps<typeof MobileSheet>) {
...
function WithDescriptionStory(args: ComponentProps<typeof MobileSheet>) {
  const [open, setOpen] = useState(false)
  return (
    <>
...
function NoFooterStory(args: ComponentProps<typeof MobileSheet>) {
  const [open, setOpen] = useState(false)
  return (
    <>
      <Button type="secondary" theme="outline" onClick={() => setOpen(true)}>
...
export const WithDescription: Story = {
  ...
  render: args => <WithDescriptionStory {...args} />,
}
...
export const NoFooter: Story = {
  ...
  render: args => <NoFooterStory {...args} />,
}
